  ...
  return (
    <div className="about">
      <div className="about">
        ...
        <p>
        Our X-ray Reading Tool is a state-of-the-art, end-to-end solution designed to aid medical professionals in accurately classifying Chest X-ray images for the presence of pneumonia. Leveraging the power of <a href='https://www.tensorflow.org/'> TensorFlow 2.x </a> and <a href='https://www.tensorflow.org/hub'> TensorFlow Hub</a>, our tool employs advanced deep learning and transfer learning techniques to achieve high-precision results.
        </p>
        <section>
        ...
        <section>
          <h2>Data</h2>
          <p>
          To develop and train our X-ray Reading Tool, we have utilized the Chest X-Ray Images (Pneumonia) dataset from Kaggle. This dataset is a widely recognized and reputable collection of labeled Chest X-ray images, making it a reliable source for training and evaluation.
          </p>
          <p>
        ...
        <section>
          ...
          <ul>
            ...
            <li>Comprehensive Test Set: To evaluate the tool&apos; performance, we have curated a test set comprising approximately 3,000 Chest X-ray images without labels. These images will be used for prediction, allowing us to assess the model&apos;s ability to make accurate and reliable classifications on unseen data.</li>
          </ul>
        </section>
        <section>
          <h2>References:</h2>
